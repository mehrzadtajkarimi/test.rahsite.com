  ...
  <script>
      $(".btn-right").click(function() {
          ...
          $(".span").html('<img class="wow rotateIn shake" data-wow-duration="1s" src="'<?= asset_url() ?>'/image/finger-hand-right.png">');
      ...
      $(".btn-left").click(function() {
          ...
          $(".span").html('<img class="wow rotateIn shake" data-wow-duration="1s"" src="'<?= asset_url() ?>'/image/finger-hand-left.png" >');
