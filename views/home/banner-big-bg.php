<section id="banner-big-bg">
    <div class="movieh">
        <div class="movieh__card">
            <div class="layer-1 wow fadeIn" data-wow-delay=".5s" data-wow-duration="1s"></div>
            ...
            <div class="layer-3">
                ...
                <div id="logo-layer3" class=" position-relative d-none d-sm-block">
                    <img src="<?= asset_url() ?>/image/logo--1.svg" alt="logo" class="position-absolute  wow fadeIn"
                         data-wow-delay="1s" data-wow-duration="5s">
                    <img src="<?= asset_url() ?>/image/logo--2.svg" alt="logo" class="position-absolute  wow  bounceInRight"
                         data-wow-delay="2s">
                    <img src="<?= asset_url() ?>/image/logo--3.svg" alt="logo" class="position-absolute  wow bounceInLeft"
                         data-wow-delay="2s">
                    <img src="<?= asset_url() ?>/image/logo--4.svg" alt="logo" class="position-absolute  wow slideInDown"
