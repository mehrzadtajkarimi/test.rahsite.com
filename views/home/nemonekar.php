                    ...
                    <div class="flip-box bg-transparent cursor-pointer">
                        <div class="flip-box-inner">
                            ...
                            <div  class="flip-box-back d-flex justify-content-center bg-light shadow">
                                <img  src="<?= asset_url() ?>/image/Type-design-company.jpg" alt="contract_management">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="Type-design-template">
                    <div class="flip-box bg-transparent cursor-pointer">
                        <div class="flip-box-inner">
                            ...
                            <div class="flip-box-back d-flex justify-content-center bg-light shadow">
                                <img src="<?= asset_url() ?>/image/Type-design-store.jpg" alt="contract_management">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="Type-design-template">
                    <div class="flip-box bg-transparent cursor-pointer">
                        <div class="flip-box-inner">
                            ...
                            <div class="flip-box-back d-flex justify-content-center bg-light shadow">
                                <img src="<?= asset_url() ?>/image/Type-design-personal.jpg" alt="contract_management">
                            </div>
                        </div>
                    </div>
                </div>
