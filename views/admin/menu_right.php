<header>
    <link rel="icon" href="<?= asset_url() ?>/image/icon.png" type="image/png">
    <link rel="stylesheet" href="<?= asset_url() ?>/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= asset_url() ?>/css/animate.css">
    <link rel="stylesheet" href="<?= asset_url() ?>/css/style.css">
    <script src="<?= asset_url() ?>/js/jquery-2.1.3.min.js"></script>
    ...
    <style>
        * {
        ...
        @font-face {
            font-family: 'myfont';
            src: url("<?= asset_url() ?>/fonts/IRANSans-web.ttf") format("truetype"), url("<?= asset_url() ?>/fonts/IRANSans-web.eot") format("eot"), url("<?= asset_url() ?>/fonts/IRANSans-web.woff") format("woff"), url("<?= asset_url() ?>/fonts/IRANSans-web.woff2") format("woff2");
            font-style: normal;
            font-weight: normal;
        }
        @font-face {
            font-family: 'myfont1';
            src: url('<?= asset_url() ?>/fonts/BYekan.eot') format('eot'), url('<?= asset_url() ?>/fonts/BYekan.ttf') format('truetype'), url('<?= asset_url() ?>/fonts/BYekan.woff') format('woff');
            font-style: normal;
            font-weight: normal;
        }
        @font-face {
            font-family: 'myfont2';
            src: url("<?= asset_url() ?>/fonts/B.Shekari.ttf") format("truetype");
        }
...
<div class="row">
    <div class="col-lg-2 col " id="nav-right">
        ...
        <a class="d-none d-lg-block" href="http://www.webzad.ir/">
            <img src="<?= asset_url() ?>/image/logo1.png" class="img-fluid w-50 m-auto d-block pt-5" alt="logo_rahsite">
        </a>
    </div>
