        ...
        <nav id="nav" class="container-fluid  border-bottom mb-6 mb-lg-0 shadow-sm">
            <div class="row">
                ...
                <ul class="nav flex-column flex-lg-row menu mr-lg-5 mt-lg-2 mb-lg-2 ">
                    ...
                    <li class="nav-item  d-lg-block ">
                        <a class="nav-link cursor-pointer" href="<?= URL ?>articlesCategorize"><i
                                class="far fa-edit d-lg-none"></i> نوشته های
                            من </a>
                    </li>
                    <li class="nav-item  d-lg-block ">
                ...
                <a id="image-logo" href="index.php" class="position-absolute d-block cursor-pointer"
                    style="left: 4em; top: .2em;">
