        ...
        <div class="row">
            ...
            <ul class="nav flex-column flex-lg-row menu mr-lg-5 mt-lg-2 mb-lg-2 ">
                <li class="nav-item active d-lg-block ">
                    <a class="nav-link cursor-pointer" href="index.php"><i class="fas fa-home d-lg-none"></i> خانه <span
                                class="sr-only ">(current)</span>
                    </a>
                </li>
                <li class="nav-item  d-lg-block ">
                    <a class="nav-link cursor-pointer"><i class="fab fa-creative-commons-sampling d-lg-none"></i> نمونه
                        کار
                        های من </a>
                </li>
                <li class="nav-item  d-lg-block ">
                    <a class="nav-link cursor-pointer" href="<?=URL?>categorizeArticles"><i class="far fa-edit d-lg-none"></i> نوشته های
                        من </a>
                </li>
                <li class="nav-item  d-lg-block ">
                    <a class="nav-link cursor-pointer" href="https://t.me/mehrzad_tajkarimi"><i
            ...
            <!--            <a id="user-login" href="users/register.php" class="mt-3 d-lg-block d-none mr-5 "  title="ثبت نام/ورود">-->
